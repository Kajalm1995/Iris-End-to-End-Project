# Streamlit Web application for Pharma Drugs prediction - Kajal Mahore
...
# Create a Header
st.set_page_config(page_title='Pharma Drugs - Kajal')

# Add a title to application in body
st.title("Pharma Drugs Prediction - Kajal Mahore")
...
# Take Cholesterol as input from user
...
def predict_drugs(pipe_path, model_path):
    ...
    # Load the pipeline from the input notebook folder
